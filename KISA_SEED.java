public class KISA_SEED
{
    ...
    private static void F(int[] T, int LR[], int L0, int L1, int R0, int R1, int[] K, int K_offset)
    {
    ...
    public void KeySchedule(byte[] mKey, int[] rKey)
    {
        int ABCD[] = new int[4];
        int T[] = new int[2];
    ...
    public void Encrypt(int[] output, int[] input, int[] roundKey)
    {
        int LR[] = new int[4];
        int T[] = new int[2];
        ...
        F(T, LR, 0, 1, 2, 3, roundKey,  0);
        F(T, LR, 2, 3, 0, 1, roundKey,  2);
        F(T, LR, 0, 1, 2, 3, roundKey,  4);
        F(T, LR, 2, 3, 0, 1, roundKey,  6);
        F(T, LR, 0, 1, 2, 3, roundKey,  8);
        F(T, LR, 2, 3, 0, 1, roundKey, 10);
        F(T, LR, 0, 1, 2, 3, roundKey, 12);
        F(T, LR, 2, 3, 0, 1, roundKey, 14);
        F(T, LR, 0, 1, 2, 3, roundKey, 16);
        F(T, LR, 2, 3, 0, 1, roundKey, 18);
        F(T, LR, 0, 1, 2, 3, roundKey, 20);
        F(T, LR, 2, 3, 0, 1, roundKey, 22);
        F(T, LR, 0, 1, 2, 3, roundKey, 24);
        F(T, LR, 2, 3, 0, 1, roundKey, 26);
        F(T, LR, 0, 1, 2, 3, roundKey, 28);
        F(T, LR, 2, 3, 0, 1, roundKey, 30);
    ...
    public void Decrypt(int[] pOut, int[] pIn, int[] rKey)
    {
        ...
        F(T, LR, 0, 1, 2, 3, rKey, 30);
        F(T, LR, 2, 3, 0, 1, rKey, 28);
        F(T, LR, 0, 1, 2, 3, rKey, 26);
        F(T, LR, 2, 3, 0, 1, rKey, 24);
        F(T, LR, 0, 1, 2, 3, rKey, 22);
        F(T, LR, 2, 3, 0, 1, rKey, 20);
        F(T, LR, 0, 1, 2, 3, rKey, 18);
        F(T, LR, 2, 3, 0, 1, rKey, 16);
        F(T, LR, 0, 1, 2, 3, rKey, 14);
        F(T, LR, 2, 3, 0, 1, rKey, 12);
        F(T, LR, 0, 1, 2, 3, rKey, 10);
        F(T, LR, 2, 3, 0, 1, rKey,  8);
        F(T, LR, 0, 1, 2, 3, rKey,  6);
        F(T, LR, 2, 3, 0, 1, rKey,  4);
        F(T, LR, 0, 1, 2, 3, rKey,  2);
        F(T, LR, 2, 3, 0, 1, rKey,  0);
